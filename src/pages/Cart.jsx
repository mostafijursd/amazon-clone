...
<div className='w-2/5' >
        ...
        <div className='w-4/5' >
            ...
            <p className='text-base'>Unit Price <span className='font-semibold'>${item.price}</span>
             </p>
    ...
    <div className='w-full py-2'>
        <button  onClick={()=>dispatch(resetCart())} className='px-10 py-2 bg-red-500 hover:bg-red-600 active:bg-red-500 text-white
        rounded-lg font-titleFont font-semibold text-lg tracking-wide'>Clear Cart</button>
    </div>
</div>
...
<div>
    <p  className='font-semibold px-10 py-1 flex items-center  gap-2 justify-between'>Total: <span  className='font-semibold'>${totalPrice}</span></p>
</div>
<button   className='w-full font-titleFont font-semibold text-base bg-gradient-to-tr from-yellow-400 to-yellow-200
border hover:from-yellow-300 hover:to-yellow-200 border-yellow-500 hover:border-yellow-700 active:bg-gradient-to-bl
